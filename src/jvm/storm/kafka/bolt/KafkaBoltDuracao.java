 ...
 * respectively.
 */
public class KafkaBoltDuracao<K, V> extends BaseRichBolt {

    private static final Logger LOG = LoggerFactory.getLogger(KafkaBoltDuracao.class);

    public static final String TOPIC = "duracao";
