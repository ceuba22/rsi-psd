 ...
 * respectively.
 */
public class KafkaBoltTaxa<K, V> extends BaseRichBolt {

    private static final Logger LOG = LoggerFactory.getLogger(KafkaBoltTaxa.class);

    public static final String TOPIC = "taxa";
